...
const dictionaries: Record<AppLanguage, Dictionary> = {
  de: {
    ...
    'library.openSettings': 'Einstellungen oeffnen',
    ...
    'scan.ocrRunning': 'Titelerkennung laeuft...',
    'scan.ocrError': 'Erkennungsfehler: {message}',
    'scan.searchRunning': 'Suche in Wikidata...',
    ...
    'scan.fetchWiki': 'Hole Wikipedia-Details...',
    ...
    'scan.pickGallery': 'Aus Galerie waehlen',
    ...
    'settings.languageHelp': 'Waehle die App-Sprache.',
    'settings.languageGerman': 'Deutsch',
    'settings.languageEnglish': 'English',
    'settings.supabaseTitle': 'Supabase Datenbank',
    'settings.supabaseDescription': 'Kostenloses Konto auf supabase.com erstellen, SQL-Schema aus supabase/schema.sql ausfuehren und Zugangsdaten eingeben.',
    'settings.openSupabase': 'Supabase im Browser oeffnen',
    'settings.openSupabaseError': 'Supabase-Link konnte nicht geoeffnet werden.',
    ...
    'settings.geminiDescription': 'Kostenlosen API-Schluessel auf aistudio.google.com erstellen (15 Anfragen/Minute gratis). Ohne Key wird der Filmtitel manuell eingegeben.',
  ...
  en: {
    ...
    'scan.searchRunning': 'Searching Wikidata...',
    ...
    'scan.fetchWiki': 'Loading Wikipedia details...',
