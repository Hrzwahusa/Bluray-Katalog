...
const dictionaries: Record<AppLanguage, Dictionary> = {
  de: {
    ...
    'settings.geminiDescription': 'Kostenlosen API-Schlüssel auf aistudio.google.com erstellen (15 Anfragen/Minute gratis).',
  ...
  en: {
    ...
    'settings.geminiDescription': 'Create a free API key on aistudio.google.com (15 req/min free).',
    'settings.geminiKey': 'Gemini API Key',
